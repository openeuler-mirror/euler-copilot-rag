...
class DocumentConvertor():
    ...
    def convert_entity_to_dto(document_entity: DocumentEntity, document_type_entity: DocumentTypeEntity
        ...
        return DocumentDTO(id=str(document_entity.id), name=document_entity.name,
                           extension=document_entity.extension, document_type=document_type_dto,
                           chunk_size=document_entity.chunk_size, status=document_entity.status,
                           enabled=document_entity.enabled, parser_method=document_entity.parser_method,
