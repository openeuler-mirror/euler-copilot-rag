...
class KnowledgeConvertor():
    ...
    @staticmethod
    def convert_dict_to_entity(tmp_dict):
    ...
    def convert_entity_to_dto(entity: KnowledgeBaseEntity,
        ...
        return KnowledgeBaseDTO(
            id=str(entity.id),
            name=entity.name, language=entity.language, description=entity.description,
            embedding_model=entity.embedding_model, default_parser_method=entity.default_parser_method,
            default_chunk_size=entity.default_chunk_size, document_count=entity.document_number,status=entity.status,
            document_size=entity.document_size, document_type_list=document_type_dto_list,
