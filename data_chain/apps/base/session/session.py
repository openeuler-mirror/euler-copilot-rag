...
class SessionManager:
    ...
    def create_csrf_token(session_id: str) -> str | None:
        ...
        hmac_processor = hmac.new(key=base64.b64decode(config["CSRF_KEY"]), msg=csrf_b64, digestmod=hashlib.sha256)
    ...
    def verify_csrf_token(session_id: str, token: str) -> bool:
        ...
        hmac_obj = hmac.new(key=base64.b64decode(config["CSRF_KEY"]),
